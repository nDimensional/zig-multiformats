...
pub const Codec = enum(u32) {
    ...
    inline fn getCode(val: u64) !Codec {
        if (val > std.math.maxInt(u32)) {
            return error.INVALID_MULTIHASH_CODE;
        }
    ...
    pub fn encode(buf: []const u8, codec: Codec) usize {
        return varint.encode(buf, @intFromEnum(codec));
    }

    pub fn write(writer: std.io.AnyWriter, codec: Codec) !void {
    ...
    es256k = 0xd0e7,
    @"bls-12381-g1-sig" = 0xd0ea,
    @"bls-12381-g2-sig" = 0xd0eb,
    eddsa = 0xd0ed,
    @"eip-191" = 0xd191,
    @"jwk_jcs-pub" = 0xeb51,
